# ==============================================================================
# A Hybrid RAG-based Forensic Framework for Deepfake Detection (Final Version)
# ==============================================================================
# This script implements the two-stage deepfake detection pipeline.
# All previously discussed bugs, including the PyTorch gradient error and the
# LLaVA JSON parsing error, have been corrected.
# ==============================================================================
...
class PixelDetector:
    ...
    def __init__(self, target_size=299):
        ...
        self.face_detector = MTCNN(keep_all=False, device=DEVICE) # keep_all=False simplifies logic to one face
...
"""
        ...
        try:
            ...
            # Remove invalid escape characters added by the LLaVA model
